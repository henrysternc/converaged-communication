...
public interface RedisKeyIds {
    ...
    public static final String LINK_STATUS_MESH = "LINK_STATUS_MESH";
    public static final String LINK_STATUS_LTE_R = "LINK_STATUS_LTE_R";
    public static final String LINK_STATUS_4G = "LINK_STATUS_4G";
    public static final String LINK_STATUS_SAT = "LINK_STATUS_SAT";

    public static final String COUNT_MESH = "COUNT_MESH";
    public static final String COUNT_LTE_R = "COUNT_LTE_R";
    public static final String COUNT_4G = "COUNT_4G";
    public static final String COUNT_SAT = "COUNT_SAT";

    public static final String DEVICE_INFO_PREFIX = "DEVICE_INFO_PREFIX-";
